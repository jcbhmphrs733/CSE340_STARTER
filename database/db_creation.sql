...
-- examples of deleting data from tables and reseting auto-generated ids to 1
-- DELETE FROM public.classification;
-- TRUNCATE TABLE inventory, classification RESTART IDENTITY;
-- ALTER TABLE public.inventory ADD COLUMN inv_color varchar;
